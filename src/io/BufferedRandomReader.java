 ...
 */
public class BufferedRandomReader extends RandomAccessFile {
    /**
     ...
     * @throws IOException
     */
    public BufferedRandomReader(String filename, String mode, int bufsize)
            throws IOException {
        super(filename, mode);
        invalidate();
        BUF_SIZE = bufsize;
    ...
    public BufferedRandomReader(File file, String mode, int bufsize)
            throws IOException {
